                ...
                <ul>
                    <li onClick={handleClick}>                                               
                            <div className="productImage">
                                <img src="images/cat2_01.jpg" alt=""/>
                            </div>
                            <div className="produtctDetails">
                                <h2 className="productTitle">Coca Cola</h2>
                                <p className="productDescription">Descrição exemplo, descrição exemplo...</p>
                                <p className="productPrice">R$10,00</p>
                    ...
                    <li onClick={handleClick}>                                               
                            <div className="productImage">
                                <img src="images/cat2_02.jpg" alt=""/>
                            </div>
                            <div className="produtctDetails">
                                <h2 className="productTitle">Guaraná Antartica</h2>
                                <p className="productDescription">Descrição exemplo, descrição exemplo...</p>
                                <p className="productPrice">R$8,00</p>
                                <IconButton icon="search"/>
                            </div>                                              
                    </li>
                </ul>
